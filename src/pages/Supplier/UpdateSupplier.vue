...
<div class="box-title box-title-fix">
    <h2 class="title-page">Update Supplier</h2>
...
<div class="card form-fix">
    <div class="row">
        <div class="col-sm-12">
            <div class="card-body">
                <h4 class="card-title mb-3" style="font-size: 15px;">Information Supplier</h4>
...
components: { index },
    ...
    methods:{
        ...
        try{
            const response = await SupplierService.update(this.token, this.dataSupplier, this.idSupplier)
    ...
    async fetchData(){
            const response = await SupplierService.getDetail(this.token ,this.idSupplier) 
            if (response.status == 200) {
