            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button class="buttonYes mt-3"  @click="deleteData(branch.id)" style="font-size: 13px;">Confirm</button>
                        <button class="buttonNo mt-3" @click="$bvModal.hide(String(branch.id))" style="font-size: 13px;">Cancel</button>
                        </div>
                        </b-modal>
                        </div>
